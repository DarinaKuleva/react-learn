import { TDish, TRestaurant, TReview, TUser } from './mocks-interface.ts';

export const normalizedRestaurants: NormalizedRestaurants = [
  {
...
export const normalizedDishes: Array<TDish> = [
  {
...
export const normalizedReviews: Array<TReview> = [
  {
...
export const normalizedUsers: Array<TUser> = [
  {
...
export type NormalizedRestaurants = Array<TRestaurant>;
